...
public class RestaurantTest {
	...
	@Test
	public void testStringToJsonArrayMissingValue(){
		String jsonString = "Chinese,Japanese";
		JSONArray new_jsonArray = Restaurant.stringToJSONArray(jsonString);
		//System.out.println(new_jsonArray);
		JSONArray jsonArray = new JSONArray();
		jsonArray.put("Chinese");
		jsonArray.put("Japanese");
		//System.out.println(jsonArray);
		//assertEquals(jsonArray, new_jsonArray);
//		Assert.assertEquals(new_jsonArray, jsonArray);
